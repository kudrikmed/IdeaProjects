...
/**
 * Created by ÑÂÊ on 10.02.2016.
 */
public class SitWorkout extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        muscules.setImageDrawable(getResources().getDrawable(R.drawable.msit));
    ...
    int workoutnumber = pref.getInt("SIT_WORKOUT_NUMBER",0);

        if(workoutnumber == 0)
        {
            SharedPreferences.Editor edit = pref.edit();
            edit.putInt("SIT_WORKOUT_NUMBER", 1);
            edit.commit();
        }

    Cursor cursor = sdb.query("situps",
            null,
            "_id = " + pref.getInt("SIT_WORKOUT_NUMBER", 0), null,
            null, null, null);
...

   {
    ...
    //   mp.start();
           ...
           mCountDownTimer = new CountDownTimer(3000, 1000) {
               ...
               public void onFinish() {
                   ...
                   if (setnumber == 5) {
                       ...
                       if (pref.getInt("SIT_WORKOUT_NUMBER", 0) < 18) {
                           edit.putInt("SIT_WORKOUT_NUMBER", pref.getInt("SIT_WORKOUT_NUMBER", 0) + 1);
                       }
                       else
                           {edit.putInt("SIT_WORKOUT_NUMBER", pref.getInt("SIT_WORKOUT_NUMBER", 0));}
                       edit.commit();
                       ...
                       values.put("total", tot);
                        ...
                        sdb.insert("situphistory", null, values);
                       mDbHelper.close();
       ...
       {
           Intent intentGoToMain = new Intent(SitWorkout.this, DashboardActivity.class);

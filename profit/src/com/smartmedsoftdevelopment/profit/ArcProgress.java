...
public class ArcProgress extends View {
    ...
    private String suffixText = "";   //changed
    private float suffixTextPadding;

    private float arcBottomHeight;

  //  private final int default_finished_color = Color.WHITE;
    private final int default_unfinished_color = getResources().getColor(R.color.gold);
   // private final int default_finished_color = Color.rgb(72, 106, 176);
   private final int default_finished_color = getResources().getColor(R.color.blue);
    ...
    private final int default_max = 120;   // changed

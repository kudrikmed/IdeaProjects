 ...
 */
public class DateSelectorPull extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String pref = "PULL_WORKOUT_NUMBER";
           ...
           public void onClick(View view) {
               ...
               switch (rb.getId())
               {
                   case R.id.radioButtonWeek1:
                       ...
                       edit.putInt(pref, 1);
                       edit.commit();
                       Intent intentDashboard = new Intent(DateSelectorPull.this, TabPullActivity.class);
                   ...
                   case R.id.radioButtonWeek2:
                       ...
                       edit.putInt(pref, 2);
                       edit.commit();
                       intentDashboard = new Intent(DateSelectorPull.this, TabPullActivity.class);
                       startActivity(intentDashboard);
                       finish();
                       break;

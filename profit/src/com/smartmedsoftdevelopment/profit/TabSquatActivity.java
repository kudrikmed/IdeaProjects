 ...
 */
public class TabSquatActivity extends android.app.TabActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String title = getResources().getString(R.string.week) + " " + cursor.getString(cursor.getColumnIndex("week")) + " " +
                getResources().getString(R.string.day) + " " + cursor.getString(cursor.getColumnIndex("day"))+ " - " + getResources().getString(R.string.btn_squats);
...
*/
   ...
   */
        ...
        tabSpec.setContent(new Intent(this, SquatWorkout.class));
        ...
        tabSpec.setContent(new Intent(this, SquatStatistics.class));
        tabHost.addTab(tabSpec);

        tabSpec = tabHost.newTabSpec("tag3");
        //  tabSpec.setIndicator(getString(R.string.today));
        tabSpec.setIndicator(getString(R.string.chart));
        tabSpec.setContent(new Intent(this, ChartSquatActivity.class));
        tabHost.addTab(tabSpec);

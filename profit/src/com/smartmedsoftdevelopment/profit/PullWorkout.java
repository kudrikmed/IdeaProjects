 ...
 */
public class PullWorkout extends Activity {
    int i=120;
    int setnumber = 0;
    ...
    public int PULL_WORKOUT_NUMBER;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        muscules.setImageDrawable(getResources().getDrawable(R.drawable.mpullup));
        ...
        int workoutnumber = pref.getInt("PULL_WORKOUT_NUMBER",0);

        if(workoutnumber == 0)
        {
            SharedPreferences.Editor edit = pref.edit();
            edit.putInt("PULL_WORKOUT_NUMBER", 1);
            edit.commit();
        }

        Cursor cursor = sdb.query("pullups",
                null,
                "_id = " + pref.getInt("PULL_WORKOUT_NUMBER", 0), null,
                null, null, null);
...

    {
            ...
            mCountDownTimer = new CountDownTimer(3000, 1000) {
                ...
                public void onFinish() {
                    ...
                    if (setnumber == 5) {
                        ...
                        if (pref.getInt("PULL_WORKOUT_NUMBER", 0) < 18) {
                            edit.putInt("PULL_WORKOUT_NUMBER", pref.getInt("PULL_WORKOUT_NUMBER", 0) + 1);
                        }
                        else
                        {edit.putInt("PULL_WORKOUT_NUMBER", pref.getInt("PULL_WORKOUT_NUMBER", 0));}
                        edit.commit();
                        ...
                        sdb.insert("pulluphistory", null, values);
                        mDbHelper.close();
        ...
        {
            Intent intentGoToMain = new Intent(PullWorkout.this, DashboardActivity.class);

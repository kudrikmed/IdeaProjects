 ...
 */
public class ChartPullActivity extends Activity {
    @Override
    ...
    void DrawAChart()
    {
        ...
        Cursor cursor = sdb.rawQuery("SELECT total FROM pulluphistory",
                null);
        //  cursor.moveToFirst();
...
/*
     ...
     */
        for (int i = 0; i < numberof.size(); i++) {
            valuesofex.add(new PointValue(i+1, Integer.parseInt(numberof.get(i))));
...
*/
        ...
        Axis axisX = new Axis().generateAxisFromRange(1, 20, 1);

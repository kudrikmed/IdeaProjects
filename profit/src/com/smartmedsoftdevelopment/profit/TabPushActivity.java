 ...
 */
public class TabPushActivity extends android.app.TabActivity {
...
public void onCreate(Bundle savedInstanceState) {
        ...
        null,
        "_id = " + pref.getInt("PUSH_WORKOUT_NUMBER", 1), null,
        null, null, null);

        cursor.moveToFirst();
        String title = getResources().getString(R.string.week) + " " + cursor.getString(cursor.getColumnIndex("week")) + " " +
        getResources().getString(R.string.day) + " " + cursor.getString(cursor.getColumnIndex("day"))+ " - " + getResources().getString(R.string.btn_pushup);
...
*/
   ...
   */
        ...
        tabSpec.setContent(new Intent(this, PushWorkout.class));
        ...
        tabSpec.setContent(new Intent(this, PushupStatistics.class));
        tabHost.addTab(tabSpec);

        tabSpec = tabHost.newTabSpec("tag3");
        //  tabSpec.setIndicator(getString(R.string.today));
        tabSpec.setIndicator(getString(R.string.chart));
        tabSpec.setContent(new Intent(this, ChartPushActivity.class));
        tabHost.addTab(tabSpec);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.signChange:
                Intent intentSetSign = new Intent(TabPushActivity.this, DateSelectorPush.class);

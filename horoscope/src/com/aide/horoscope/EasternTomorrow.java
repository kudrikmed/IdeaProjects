 ...
 */
public class EasternTomorrow extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.easterntoday);
        context = this;
      ...
      /*
        ...
        */
        ...
        Sender sender = new Sender(mSettings.getString("westernsign", "aries"), getString(R.string.server_ip_easterntomorrow), getString(R.string.language));
        TextView sign = (TextView) findViewById(R.id.sing);
        sign.setText(mSettings.getString("chinesesign", "monkey"));

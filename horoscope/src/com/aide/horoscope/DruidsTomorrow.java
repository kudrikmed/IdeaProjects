 ...
 */
public class DruidsTomorrow extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.celtictoday);
        context = this;
      ...
      /*
        ...
        */
        ...
        Sender sender = new Sender(mSettings.getString("westernsign", "aries"), getString(R.string.server_ip_druidstomorrow), getString(R.string.language));

 ...
 */
public class TabDruidsActivity extends android.app.TabActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        tabSpec.setContent(new Intent(this, DruidsToday.class));
        tabHost.addTab(tabSpec);


        tabSpec = tabHost.newTabSpec("tag1");
        tabSpec.setIndicator(getString(R.string.tomorrow));
        tabSpec.setContent(new Intent(this, DruidsTomorrow.class));
        tabHost.addTab(tabSpec);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.signChange:
                Intent intentSetSign = new Intent(TabDruidsActivity.this, SettingsActivity.class);

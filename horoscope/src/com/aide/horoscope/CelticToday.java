 ...
 */
public class CelticToday extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
      ...
      /*
        ...
        */
        ...
        Sender sender = new Sender(mSettings.getString("westernsign", "aries"), getString(R.string.server_ip_celtic), getString(R.string.language));

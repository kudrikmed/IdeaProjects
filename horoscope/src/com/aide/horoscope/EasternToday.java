 ...
 */
public class EasternToday extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
      ...
      /*
        ...
        */
        ...
        Sender sender = new Sender(mSettings.getString("westernsign", "aries"), getString(R.string.server_ip_eastern), getString(R.string.language));

 ...
 */
public class DruidsToday extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
      ...
      /*
        ...
        */
        ...
        Sender sender = new Sender(mSettings.getString("westernsign", "aries"), getString(R.string.server_ip_druids), getString(R.string.language));
